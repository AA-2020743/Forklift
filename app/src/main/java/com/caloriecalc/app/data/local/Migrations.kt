...
/** v9 -> v10: archived foods are hidden from add-food lists but retained for meal history. */
val MIGRATION_9_10 = object : Migration(9, 10) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE food_items ADD COLUMN `isArchived` INTEGER NOT NULL DEFAULT 0")
    }
}
